...
#       redirect_to users_path, notice: t("common.the_user") + " " + t("common.with_name") + " " + Users::Admin.last.first_name  + " " +
#         Users::Admin.last.last_name + "," + " " + t("common.and") + " " + t("common.with_email") + " " + Users::Admin.last.email + " " + t("common.created")
#     else
#       render 'new'
#     end
#   end
...
#
#   def admin_params
#     params.require(:admin).permit(:first_name, :last_name, :email, :roles, courses_attributes: [:id, :course_name, :_destroy])
#   end
#
#   def set_admin
#     @admin = Users::Admin.find(params[:id])
